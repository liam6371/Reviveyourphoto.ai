    ...
    <div className="min-h-screen bg-warm-beige">
      ...
      <section className="relative py-24 px-6 film-grain">
        ...
        <div className="container mx-auto text-center max-w-5xl relative z-10">
          ...
          {/* Enhanced Demo Section with Multiple Options */}
          <div className="mb-12">
            <div className="relative max-w-4xl mx-auto">
              {/* Try Video First, Fallback to GIF, Then Static Images */}
              <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-gradient-to-br from-deep-navy/5 to-rich-coral/5">
                ...
                <div className="hidden w-full h-96 bg-gradient-to-r from-gray-100 to-gray-200 flex items-center justify-center relative overflow-hidden">
